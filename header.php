<div class="container-fluid ">
        <div class="row py-1 justify-content-around">
            <div class="col-12 col-md-6 col-lg-6 text-center">
                <div class="container">
                    <div class="row">
                        <a href="https://www.linkedin.com/in/bipul-bimali/" class="social col-4 text-center">
                        ...
                        <a href="https://github.com/Bipul-Bimali" class="social col-4 text-center">
                        ...
                        <a href="https://app.hackthebox.com/users/1507114" class="social col-4 text-center">
                            <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
            ...
            <div class="container">
                    <div class="row">
                        <a href="tel:+14164096440" class="social col-6 text-center">
                        ...
                        <a href="mailto:bimalibipul@gmail.com" class="social col-6 text-center">
