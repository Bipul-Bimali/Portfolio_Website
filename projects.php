        ...
        switch ($project) {
            case "rubber-ducky": 
                ...
                $meta = [
                    ...
                    'description' => 'A hands-on cybersecurity project by AirCorp demonstrating physical access exploitation using a USB Rubber Ducky and Raspberry Pi 4. Includes reverse shell execution, encrypted tunnels, IoT-based C2, PowerShell obfuscation, and Linux hardening techniques.',
            ...
            case "linux-recovery": 
                ...
                $meta = [
                    'charset' => 'UTF-8',
                    'viewport' => 'width=device-width, initial-scale=1.0',
                    'description' => 'A practical Linux recovery project by AirCorp focusing on restoring secure SSH access, repairing broken key configurations, fixing user permissions, and enforcing least‑privilege principles using TTY-based recovery and system integrity validation.',
            ...
            case "homelab": 
                ...
                $meta = [
                    'charset' => 'UTF-8',
                    'viewport' => 'width=device-width, initial-scale=1.0',
                    'description' => 'IT consulting project by AirCorp focused on building reliable system monitoring, secure remote access, and scalable environments. Demonstrates real-world problem solving, system stability, and proactive infrastructure management for business needs.',
            ...
            case "hestia-work":
                ...
                $meta = [
                    'charset' => 'UTF-8',
                    'viewport' => 'width=device-width, initial-scale=1.0',
                    'description' => 'Hands-on web hosting infrastructure work by AirCorp using the Hestia Control Panel. Includes domain and DNS configuration, SSL deployment, file permission management, and server-side troubleshooting across Nginx/Apache and PHP-FPM in a production-style environment',
            ...
            case "linux-checks": 
                ...
                $meta = [
                    'charset' => 'UTF-8',
                    'viewport' => 'width=device-width, initial-scale=1.0',
                    'description' => 'Linux system health check project by AirCorp focusing on CPU/RAM monitoring, disk diagnostics, service validation, network health checks, and system integrity verification across multiple Linux distributions.',
            ...
            case "network-lab": 
                ...
                $meta = [
                    'charset' => 'UTF-8',
                    'viewport' => 'width=device-width, initial-scale=1.0',
                    'description' => 'Network security implementation by AirCorp, focusing on VLAN segmentation, micro-segmentation, ACLs, DHCP snooping, and port security measures within Cisco enterprise environments.',
                    'keywords' => 'Network Security, VLAN Segmentation, Access Control Lists, ACLs, Port Security, Cisco IOS, 802.1Q Trunking, DHCP Snooping, Dynamic ARP Inspection, DAI, STP Hardening, Network Hardening, Enterprise Security, AirCorp',
                    'author' => 'AirCorp',
                    'title' => isset($title) ? "$title | AirCorp" : 'AirCorp',
                    'og' => [
                        'title' => isset($title) ? "$title" : 'AirCorp',
            ...
            default:
                ...
                $meta = [
                    'charset' => 'UTF-8',
                    'viewport' => 'width=device-width, initial-scale=1.0',
                    'description' => 'Explore AirCorp\'s projects in Linux Administration, DevOps, Cloud (AWS/Azure), Cybersecurity, and Full-Stack Development. Case studies on penetration testing, system recovery, cloud deployment, and secure web hosting.',
